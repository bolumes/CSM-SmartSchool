   ...
   @include('partials.sidebarwelcome')
    ...
    <div class="main-content">
        <fieldset style="border-radius: 8px; border: 2px solid blue">
            <legend style="text-align: center;"><h3 style="text-align: center; color: blue;">{{ __('messages.Search for buildings') }}</h3></legend>
        ...
        <div class="container">
            ...
            <div class="form-container">
                <form class="d-flex align-items-center w-100 gap-2" action="{{ route('edificios.search') }}" method="GET">
                    @csrf
                ...
                @if(count($edificios))
                            ...
                            <tbody>
                                @foreach ($edificios as $edificio)
                                    <tr style="background-color: #d0d3d4 ; color: black;">
                                        ...
                                        <td align="center" >
                                            <a href="{{ route('edificios.show', $edificio->id) }}" class="btn btn-sm btn-primary me-1">
                                                detalhes
                                            </a>
                                        </td>
                                        <td align="center">
                                            <a href="{{ route('edificios.edit', $edificio->id) }}" class="btn btn-sm btn-warning">
                                                editar
                                            </a>
                                        </td>
                                    </tr>
                    ...
                    <!-- Paginação -->
                    @if(method_exists($edificios, 'links'))
