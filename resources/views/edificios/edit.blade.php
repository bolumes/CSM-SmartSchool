...
<div class="main-content">
    <fieldset style="border-radius:8px; border:2px solid blue">
        <legend style="text-align:center">
            <h3 style="color:blue">EDITER ÉDIFICE</h3>
        </legend>
        ...
        <div class="container">
            ...
            <form action="{{ route('edificios.update', ['edificio' => $edificio->id]) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <table class="permission-table">
                    ...
                    <tbody>
                         <tr>
                            ...
                            <td>
                                <input type="text" name="name" value="{{ old('name', $edificio->name) }}" required>
                            </td>
                         </tr>
                         <tr>
                            <td><strong>Localisation</strong></td>
                            <td>
                                <input type="text" name="location" value="{{ old('location', $edificio->location) }}" required>
                            </td>
                         </tr>
                         <tr>
                            <td><strong>Description</strong></td>
                            <td>
                                <textarea name="description" rows="5">{{ old('description', $edificio->description) }}</textarea>
                            </td>
                         </tr>
                         <tr>
                            <td colspan="2">
