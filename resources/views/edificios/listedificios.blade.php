...
<div class="main-content">
    <fieldset style="border-radius:8px; border:2px solid blue;">
        <legend style="text-align:center;">
            <h3 style="color:blue;">{{ __('messages.List of buildings') }}</h3>
        </legend>
                        ...
                        @foreach ($edificios as $edificio)
                            <tr>
                                ...
                                <td class="action-icons">
                                    <a href="{{ route('edificios.show', $edificio->id) }}" title="Ver Detalhes">
                                ...
                                @if ($isAdminOrDirection)
                                    <td class="action-icons">
                                        <a href="{{ route('edificios.edit', $edificio->id) }}" title="Editar">
                                ...
                                @if ($isAdminOrDirection)
                                    <td class="action-icons">
                                        ...
                                        <button type="button" class="btn-icon" onclick="confirmDelete({{ $edificio->id }})" title="Excluir">
...
<script>
    ...
    function confirmDelete(edificioId) {
        Swal.fire({
            title: 'Tem certeza?',
            ...
            if (result.isConfirmed) {
                document.getElementById('delete-form-' + edificioId).submit();
            }
        });
    }
</script>
