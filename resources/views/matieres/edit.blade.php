...
<div class="main-content">
    <fieldset style="border-radius:8px; border:2px solid blue">
        <legend style="text-align:center">
            <h3 style="color:blue">EDITER MATIERE</h3>
        </legend>
                ...
                <table class="permission-table">
                    ...
                    <tbody>
                         <tr>
                            ...
                            <td><input type="text" name="name" value="{{ old('name', $matiere->name) }}" required></td>
                         </tr>
                         <tr>
                            <td><strong>Code</strong></td>
                            <td><input type="text" name="code" value="{{ old('code', $matiere->code) }}" required></td>
                         </tr>
                         <tr>
                         ...
                         <tr>
                            ...
                            <td><textarea name="description" rows="5">{{ old('description', $matiere->description) }}</textarea></td>
                         </tr>
                         <tr>
                            <td colspan="2">
