...
<div class="main-content">
    <fieldset style="border-radius:8px; border:2px solid blue;">
        <legend style="text-align:center;">
            <h3 style="color:blue;">LISTES MATIERES</h3>
        </legend>
                        ...
                        @foreach ($matieres as $matiere)
                         <tr>
                            ...
                            <td class="action-icons">
                                <a href="{{ route('matieres.show', $matiere->id) }}" title="Ver Detalhes">
                            ...
                            @if ($isAdminOrDirection)
                                <td class="action-icons">
                                    <a href="{{ route('matieres.edit', $matiere->id) }}" title="Editar">
                            ...
                            @if ($isAdminOrDirection)
                                <td class="action-icons">
                                    ...
                                    <button type="button" class="btn-icon" onclick="confirmDelete({{ $matiere->id }})" title="Excluir">
    ...
    function confirmDelete(matiereId) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                document.getElementById('delete-form-' + matiereId).submit();
            }
        });
    }
</script>
