...
<div class="main-content">
    <fieldset style="border-radius:8px; border:2px solid blue;">
        <legend style="text-align:center;">
            <h3 style="color:blue;">LISTE PROFESSEURS</h3>
        </legend>
        ...
        <div class="container">
            ...
            <div class="form-container" style="overflow-x: auto;">
                        ...
                        @foreach ($professors as $professor)
                            <tr>
                                ...
                                @if ($isAdminOrDirection)
                                    <td class="action-icons">
                                        <a href="{{ route('professors.edit', $professor->id) }}" title="Editar">
                                ...
                                @if ($isAdminOrDirection)
                                    <td class="action-icons">
                                        ...
                                        <button type="button" class="btn-icon" onclick="confirmDelete({{ $professor->id }})" title="Excluir">
                ...
                <form action="{{ route('professors.export') }}" method="POST">
                    @csrf
    ...
    function confirmDelete(professorId) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                document.getElementById('delete-form-' + professorId).submit();
            }
        });
    }
</script>
