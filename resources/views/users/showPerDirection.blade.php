...
<!-- ✅ ALTERAÇÃO AQUI: removido foreach -->
<div style="margin-bottom: 40px; border:1px solid #ccc; padding:15px; border-radius:8px;">
...
<form action="{{ route('users.chatUpdate', ['user'=> $user->id]) }}" method="POST">
    ...
    <tbody>
        ...
        @php
        $chats = [
            ['label' => 'Chat - Direct', 'img' => 'img/chat3.png', 'name' => 'chat_direction', 'value' => $user->chat_direction ?? 0],
            ['label' => 'Chat - Parent', 'img' => 'img/chat4.png', 'name' => 'chat_parent', 'value' => $user->chat_parent ?? 0],
            ['label' => 'Chat - Professor', 'img' => 'img/chat1.jpg', 'name' => 'chat_professor', 'value' => $user->chat_professor ?? 0],
        ];
        @endphp
        ...
        <tr>
            <td colspan="2">
                <div class="btn-group-center">
                    ...
                    <button type="submit" class="action-btn btn-submit">Valider</button>
                </div>
            </td>
        </tr>
    </tbody>
