   ...
   @include('partials.sidebarsettings')
    ...
    <div class="main-content">
        <fieldset style="border-radius: 8px; border: 2px solid blue;">
            <legend style="text-align: center;"><h3 style="text-align: center; color: blue;">EVENTO POUR SALLE</h3></legend>
...
<div style="overflow-x: auto; margin-bottom: 2rem;">
    <table style="width: 100%; border-collapse: collapse; background-color: #fff; border: 1px solid #ccc; border-radius: 6px;">
        <thead>
            <tr>
                <th style="padding: 12px; background-color: #1c359d; color: white;">Evenemet</th>
                <th style="padding: 12px; background-color: #1c359d; color: white;">Salle</th>
            </tr>
        </thead>
        <tbody>
            @foreach($estatistics as $estatistic)
                <tr style="transition: 0.3s;" onmouseover="this.style.backgroundColor='#eef2ff'" onmouseout="this.style.backgroundColor=''">
                    <td style="padding: 10px; border: 1px solid #ccc;">{{ $estatistic->numero_de_events }}</td>
                    <td style="padding: 10px; border: 1px solid #ccc;">{{ $estatistic->sala_name }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
