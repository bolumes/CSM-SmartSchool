...
<body>
    ...
    <div class="main-content">
        <fieldset style="border-radius: 8px; border: 2px solid blue">
            <legend style="text-align: center;"><h3 style="text-align: center; color: blue;">LISTE DES PARENTS</h3></legend>
        ...
        <div class="container">
                ...
                <tbody>
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td align="center">
                                <a href="{{ route('parent.show', ['user' => $user]) }}">
                            ...
                            @if ($isAdminOrDirection || $loggedInUserId === $user->id)
                                <td align="center">
                                    <a href="{{ route('parent.edit', ['user' => $user]) }}">
            ...
            <form action="{{ route('parent.export') }}" method="POST">
                    @csrf
