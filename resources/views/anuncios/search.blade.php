    ...
    <div class="main-content">
        ...
        <div class="container">
            ...
            <div class="form-container">
                <form class="d-flex align-items-center w-100 gap-2" action="{{ route('anuncios.search') }}" method="GET">
                    @csrf
                            ...
                            <tbody>
                                @foreach ($anuncios as $anuncio)
                                    <tr style="background-color: #d0d3d4 ; color: black;">
                                        ...
                                        <td align="center">{{ $anuncio->fichier }}</td>
                                        <td align="center" >
                                            <a href="{{ route('anuncios.show', $anuncio->id) }}" class="btn btn-sm btn-primary me-1">
                                                detalhes
                                            </a>
                                        </td>
                                        <td align="center">
                                            <a href="{{ route('anuncios.edit', $anuncio->id) }}" class="btn btn-sm btn-warning">
                                                editar
                                            </a>
                                        </td>
                                    </tr>
