                ...
                <table border="1" style="width: 100%; margin: 0 auto; border-collapse: collapse;">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center">{{ $event->matiere->name ?? 'Não definido' }}</td>
                        </tr>
                        <tr>
                            <td style="text-align: center; font-weight: bold;">Professeur</td>
                            <td align="center">
                                {{ $event->professor ? $event->professor->firstname . ' ' . $event->professor->lastname : 'Não definido' }}
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: center; font-weight: bold;">Date de creation</td>
                            <td align="center">{{ $event->created_at }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
