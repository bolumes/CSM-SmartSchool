...
<div class="container d-flex flex-column justify-content-center align-items-center" style="min-height: 100vh;">
    ...
    <!-- Título -->
    <h3 class="text-center mb-3 text-primary">Deconnexion</h3>

    <!-- Imagem -->
    <div class="text-center mb-4">
        <img src="../../img/logout.png" alt="Imagem do Formulário" style="height: 80px;">
    </div>

    <!-- Seção do Formulário -->
    <div class="form-container" style="width: 100%; max-width: 500px; padding: 30px; border-radius: 10px; box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1); background-color: #fff;">
        ...
        <fieldset style="border: 2px solid #007bff; padding: 20px; border-radius: 10px;">
            <legend class="text-center" style="color: #007bff; font-size: 15px; font-weight: bold;">DECONNEXION</legend>
            <p class="text-center" style="color: #6c757d; font-size: 16px;">Sûr de vouloir vous déconnecter ?</p>

            <!-- Botão de Deconnexion -->
