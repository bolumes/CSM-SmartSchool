   ...
   @include('partials.sidebargesteventos')
    ...
    <div class="main-content">
        <fieldset style="border-radius: 8px; border: 2px solid blue">
            <legend style="text-align: center;"><h3 style="text-align: center; color: blue;">{{ __('messages.ManageEvents') }}</h3></legend>
        
        <!-- Container Principal com Imagem e Formulário -->
        <div class="container">
            <!-- Seção da Imagem -->
            <div class="form-image">
              <img src="../../img/gestevent1.png" alt="Imagem do Formulário">
            </div>
