...
<div class="main-content">
    <fieldset style="border-radius:8px; border:2px solid blue;">
        <legend style="text-align:center;">
            <h3 style="color:blue;">{{ __('messages.List of classes') }}</h3>
        </legend>
        ...
        <div class="container">
            ...
            <div class="form-container" style="overflow-x: auto;">
                ...
                <table class="permission-table">
                    <thead>
                        <tr>
                            <th>{{ __('messages.Class Code') }}</th>
                            <th>{{ __('messages.Class Name') }}</th>
                        ...
                        @foreach ($classes as $classe)
                            <tr>
                                ...
                                <td class="action-icons">
                                    <a href="{{ route('classes.show', $classe->id) }}" title="Ver Detalhes">
                                ...
                                @if ($isAdminOrDirection)
                                    <td class="action-icons">
                                        <a href="{{ route('classes.edit', $classe->id) }}" title="Editar">
                                ...
                                @if ($isAdminOrDirection)
                                    <td class="action-icons">
                                        ...
                                        <button type="button" class="btn-icon" onclick="confirmDelete({{ $classe->id }})" title="Excluir">
