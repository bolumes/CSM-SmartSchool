...
<div class="main-content">
    <fieldset style="border-radius:8px; border:2px solid blue">
        <legend style="text-align:center">
            <h3 style="color:blue">EDITER CLASSE</h3>
        </legend>
                ...
                <table class="permission-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="text" name="name" value="{{ old('name', $classe->name) }}" required></td>
                        </tr>
                        <tr>
                            <td><strong>Code</strong></td>
                            <td><input type="text" name="code" value="{{ old('code', $classe->code) }}" required></td>
                        </tr>
                        <tr>
                            <td><strong>Niveau</strong></td>
                            <td><input type="text" name="level" value="{{ old('level', $classe->level) }}"></td>
                        </tr>
                        <tr>
                            <td><strong>Description</strong></td>
                            <td><textarea name="description" rows="5">{{ old('description', $classe->description) }}</textarea></td>
                        </tr>
                        <tr>
                            <td colspan="2">
